...
//				.withMultipartRequestBody(aMultipart()).willReturn(aResponse().withStatus(HttpStatus.OK.value())
//						.withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE).withBody(read(location))));
//	}
//
